...
| movementSensibility        | number  | how resistant should shifting the view around be? (0.5 - 5) - higher is less sensitive (can set value much higher than 5 to disable shifting)                                                                                                                                                                                                                                              | 1.9       |
| movementDecayAfterShift        | boolean  | If true, the movement of the view after the shift will continue until it decays, similarly to intertial scroll                                                                                                                                                                                                                                                 | true       |
